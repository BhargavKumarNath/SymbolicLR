...
Uses the unified rust_bridge for schedule evaluation (no more duplicated MockSymbolrRust).
"""
...
class MAPElitesArchive:
    ...
    def _compute_descriptors(self, tree: Node) -> Tuple[Optional[int], Optional[int]]:
        """
        Computes (Complexity, Center of Mass) descriptors.
        Returns (None, None) if the formula evaluates to invalid math.
        """
        size = tree.size()
        try:
